...
{
    [TestFixture]
    public class FilterLevelBuilderTests
    {
...
";
        ...
        public void FiltersEventsWithMinLevel ()
        {
            ...
            var subject = FilterBuilder.Level (Level.Warn, Level.MaxValue);
        ...
        public void FiltersEventsWithMaxLevel ()
        {
            ...
            var subject = FilterBuilder.Level (Level.MinValue, Level.Warn);
        ...
        public void FiltersEventsWithLevelInterval ()
        {
            ...
            var subject = FilterBuilder.Level (Level.Info, Level.Error);
        ...
        public void FiltersEventsWithLevelExactValue ()
        {
            ...
            var subject = FilterBuilder.Level (Level.Error, Level.Error);
